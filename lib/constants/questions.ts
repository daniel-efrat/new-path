...
export const STEP7_QUESTIONS: ShapeQuestion[] = [
  {
    ...
    question: "/assets/questionnaire/shapes/1.png",
    options: [
      "/assets/questionnaire/shapes/1.1.png",
      "/assets/questionnaire/shapes/1.2.png",
      "/assets/questionnaire/shapes/1.3.png",
      "/assets/questionnaire/shapes/1.4.png",
    ],
  ...
  },
  {
    ...
    number: 2,
    level: "זיהוי דפוסים – צורות גיאומטריות",
    question: "/assets/questionnaire/shapes/2.png",
    options: [
      "/assets/questionnaire/shapes/2.1.png",
      "/assets/questionnaire/shapes/2.2.png",
      "/assets/questionnaire/shapes/2.3.png",
      "/assets/questionnaire/shapes/2.4.png",
    ],
  ...
  },
  {
    ...
    number: 3,
    level: "זיהוי דפוסים – צורות גיאומטריות",
    question: "/assets/questionnaire/shapes/3.png",
    options: [
      "/assets/questionnaire/shapes/3.1.png",
      "/assets/questionnaire/shapes/3.2.png",
      "/assets/questionnaire/shapes/3.3.png",
      "/assets/questionnaire/shapes/3.4.png",
    ],
    correct_option: 3, // Adjust based on correct answer
    type: "shape",
  },
  {
    ...
    number: 4,
    level: "זיהוי דפוסים – צורות גיאומטריות",
    question: "/assets/questionnaire/shapes/4.png",
    options: [
      "/assets/questionnaire/shapes/4.1.png",
      "/assets/questionnaire/shapes/4.2.png",
      "/assets/questionnaire/shapes/4.3.png",
      "/assets/questionnaire/shapes/4.4.png",
    ],
  ...
  },
  {
    ...
    number: 5,
    level: "זיהוי דפוסים – צורות גיאומטריות",
    question: "/assets/questionnaire/shapes/5.png",
    options: [
      "/assets/questionnaire/shapes/5.1.png",
      "/assets/questionnaire/shapes/5.2.png",
      "/assets/questionnaire/shapes/5.3.png",
      "/assets/questionnaire/shapes/5.4.png",
    ],
    correct_option: 1, // Adjust based on correct answer
    type: "shape",
  },
  {
    ...
    number: 6,
    level: "זיהוי דפוסים – צורות גיאומטריות",
    question: "/assets/questionnaire/shapes/6.png",
    options: [
      "/assets/questionnaire/shapes/6.1.png",
      "/assets/questionnaire/shapes/6.2.png",
      "/assets/questionnaire/shapes/6.3.png",
      "/assets/questionnaire/shapes/6.4.png",
    ],
    correct_option: 0, // Adjust based on correct answer
    type: "shape",
  },
  {
    ...
    number: 7,
    level: "זיהוי דפוסים – צורות גיאומטריות",
    question: "/assets/questionnaire/shapes/7.png",
    options: [
      "/assets/questionnaire/shapes/7.1.png",
      "/assets/questionnaire/shapes/7.2.png",
      "/assets/questionnaire/shapes/7.3.png",
      "/assets/questionnaire/shapes/7.4.png",
    ],
    correct_option: 0, // Adjust based on correct answer
    type: "shape",
  },
  {
    ...
    number: 8,
    level: "זיהוי דפוסים – צורות גיאומטריות",
    question: "/assets/questionnaire/shapes/8.png",
    options: [
      "/assets/questionnaire/shapes/8.1.png",
      "/assets/questionnaire/shapes/8.2.png",
      "/assets/questionnaire/shapes/8.3.png",
      "/assets/questionnaire/shapes/8.4.png",
    ],
  ...
  },
  {
    ...
    number: 9,
    level: "זיהוי דפוסים – צורות גיאומטריות",
    question: "/assets/questionnaire/shapes/9.png",
    options: [
      "/assets/questionnaire/shapes/9.1.png",
      "/assets/questionnaire/shapes/9.2.png",
      "/assets/questionnaire/shapes/9.3.png",
      "/assets/questionnaire/shapes/9.4.png",
      "/assets/questionnaire/shapes/9.5.png",
    ],
    correct_option: 0,
    type: "shape",
  },
  {
    ...
    number: 10,
    level: "זיהוי דפוסים – צורות גיאומטריות",
    question: "/assets/questionnaire/shapes/10.png",
    options: [
      "/assets/questionnaire/shapes/10.1.png",
      "/assets/questionnaire/shapes/10.2.png",
      "/assets/questionnaire/shapes/10.3.png",
      "/assets/questionnaire/shapes/10.4.png",
      "/assets/questionnaire/shapes/10.5.png",
    ],
    correct_option: 1, // Adjust based on correct answer
    type: "shape",
  },
  {
    ...
    number: 11,
    level: "זיהוי דפוסים – צורות גיאומטריות",
    question: "/assets/questionnaire/shapes/11.png",
    options: [
      "/assets/questionnaire/shapes/11.1.png",
      "/assets/questionnaire/shapes/11.2.png",
      "/assets/questionnaire/shapes/11.3.png",
      "/assets/questionnaire/shapes/11.4.png",
      "/assets/questionnaire/shapes/11.5.png",
    ],
    correct_option: 2,
    type: "shape",
  },
  {
    ...
    number: 12,
    level: "זיהוי דפוסים – צורות גיאומטריות",
    question: "/assets/questionnaire/shapes/12.png",
    options: [
      "/assets/questionnaire/shapes/12.1.png",
      "/assets/questionnaire/shapes/12.2.png",
      "/assets/questionnaire/shapes/12.3.png",
      "/assets/questionnaire/shapes/12.4.png",
      "/assets/questionnaire/shapes/12.5.png",
    ],
    correct_option: 0,
    type: "shape",
  },
  {
    ...
    number: 13,
    level: "זיהוי דפוסים – צורות גיאומטריות",
    question: "/assets/questionnaire/shapes/13.png",
    options: [
      "/assets/questionnaire/shapes/13.1.png",
      "/assets/questionnaire/shapes/13.2.png",
      "/assets/questionnaire/shapes/13.3.png",
      "/assets/questionnaire/shapes/13.4.png",
      "/assets/questionnaire/shapes/13.5.png",
    ],
    correct_option: 0, // Adjust based on correct answer
    type: "shape",
  },
  {
    ...
    number: 14,
    level: "זיהוי דפוסים – צורות גיאומטריות",
    question: "/assets/questionnaire/shapes/14.png",
    options: [
      "/assets/questionnaire/shapes/14.1.png",
      "/assets/questionnaire/shapes/14.2.png",
      "/assets/questionnaire/shapes/14.3.png",
      "/assets/questionnaire/shapes/14.4.png",
      "/assets/questionnaire/shapes/14.5.png",
    ],
    correct_option: 0, // Adjust based on correct answer
    type: "shape",
  },
...
export const RIASEC_MAP = {
  R: {
    ...
    image: "/assets/questionnaire/riasec/R.png",
  },
  I: {
    code: "I",
    name: "חקרני",
    ...
    image: "/assets/questionnaire/riasec/I.png",
  },
  A: {
    code: "A",
    name: "אומנותי",
    ...
    image: "/assets/questionnaire/riasec/A.png",
  },
  S: {
    code: "S",
    name: "חברתי",
    ...
    image: "/assets/questionnaire/riasec/S.png",
  },
  E: {
    code: "E",
    name: "יזמי",
    ...
    image: "/assets/questionnaire/riasec/E.png",
  },
  C: {
    code: "C",
    name: "מִנהלי",
    ...
    image: "/assets/questionnaire/riasec/C.png",
  },
} as const
