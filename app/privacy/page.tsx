...
export const metadata: Metadata = {
  ...
  description:
    "מדיניות הפרטיות של דרך חדשה: איזה מידע נאסף באפליקציה, למה הוא משמש, עם מי הוא עשוי להיות משותף ומהן זכויות המאובחנים.",
};
...
const dataTypes = [
  {
    ...
    body: "שם מלא, כתובת אימייל, סיסמה מוצפנת או התחברות באמצעות Google, מזהה מאובחן ונתוני אימות בסיסיים הנדרשים לניהול החשבון.",
  },
  {
  ...
  },
  {
    ...
    body: "נתוני פעילות טכניים כגון כניסות, שגיאות, קליקים על המלצות או הפניות, ונתונים שנדרשים לאבטחה, תמיכה, מניעת שימוש לרעה ושיפור חוויית המאובחן.",
  },
];
...
const sections = [
  {
    ...
    items: [
      ...
      "כדי למדוד הפניות למוסדות לימוד, אם המאובחן בוחר ללחוץ על המלצה או ליצור קשר דרך האפליקציה.",
    ],
  },
  {
    title: "עם מי המידע עשוי להיות משותף?",
    items: [
      "ספקי תשתית ואימות, ובכלל זה Supabase, לצורך שמירת מידע, ניהול מאובחנים והרשאות גישה.",
      "ספקי אוטומציה או בינה מלאכותית, כגון n8n ו-OpenAI, ככל שנעשה בהם שימוש לצורך יצירת המלצות או עיבוד תשובות.",
      "מוסדות לימוד או שותפי הפניה, רק כאשר הדבר נדרש כדי לטפל בפנייה, למדוד הפניה או לאפשר יצירת קשר בעקבות בחירה של המאובחן.",
      "רשויות מוסמכות או גורמים אחרים כאשר קיימת חובה לפי דין, צו, הליך משפטי או צורך להגן על זכויות המאובחנים והשירות.",
    ],
  },
  {
    ...
    items: [
      ...
      "לא נפרסם תשובות אישיות או תוצאות אישיות באופן שמזהה את המאובחן ללא הסכמה.",
    ],
  },
  {
      ...
      <div className="relative z-10 mx-auto max-w-5xl">
        ...
        <section className="dashboard-glass-panel rounded-lg p-6 md:p-10">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-white/82">
              ...
              מסבירה בשפה פשוטה איזה מידע המאובחן משתף באפליקציה, למה אנחנו
              צריכים אותו, איך הוא עשוי לעבור לספקים או שותפים, ואילו זכויות
              עומדות לרשות המאובחן ביחס למידע האישי שלו.
            </p>
          </div>
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-lg border border-white/20 bg-white/8 p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-white/76">
                תשובות המאובחן משמשות להתאמת מקצועות, מסלולים ומוסדות לימוד.
              </p>
            </div>
            <div className="rounded-lg border border-white/20 bg-white/8 p-4">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-start">
            ...
            <div>
              ...
              <p className="mt-4 leading-8 text-white/78">
                ...
                שנמסרו, ולא לקבוע עבור המאובחן החלטה סופית או מחייבת. מומלץ
        ...
        <section className="relative z-10 mt-8 rounded-lg border border-white/18 bg-white/9 p-6 backdrop-blur md:p-8">
          ...
          <p className="mt-4 leading-8 text-white/78">
            ...
            מאובחנים, שימוש בשירותי תשתית מאובטחים והפרדה בין מידע של מאובחנים.
        ...
        <section className="relative z-10 mt-8 rounded-lg border border-white/18 bg-white/9 p-6 backdrop-blur md:p-8">
          <h2 className="text-2xl font-bold text-white">
            זכויות המאובחן ביחס למידע
          </h2>
          <p className="mt-4 leading-8 text-white/78">
            לפי הדין החל, ובכלל זה חוק הגנת הפרטיות, ייתכן שעומדות למאובחן זכויות
        ...
        <section className="relative z-10 mt-8 rounded-lg border border-white/18 bg-white/9 p-6 backdrop-blur md:p-8">
          ...
          <p className="mt-4 leading-8 text-white/78">
            השירות מיועד למאובחנים שמסוגלים למסור מידע ולקבל החלטות לגבי שימוש
            באפליקציה. אם ייעשה שימוש בדיוור או הודעות שיווקיות, הדבר ייעשה לפי
            הדין ובאפשרות המאובחן לבקש להפסיק לקבל הודעות כאלה. אנו עשויים לעדכן
            מדיניות זו מעת לעת; שינוי מהותי יופיע בעמוד זה, ובמידת הצורך תישלח
            הודעה באמצעי הקשר שמסר המאובחן.
          </p>
        </section>
