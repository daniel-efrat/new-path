      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          {stepDetails.map((details, index) => {
            const step = steps.find((s: any) => s.id === details.id) || { isCompleted: false, isLocked: true }
            return (
              <Card
                key={details.id}
                className={cn(
                    ...
                    >
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        {step.isCompleted && (
                          <Badge
                            variant="default"
                            className="bg-green-500 text-white animate-in slide-in-from-right duration-300"
                            style={{
