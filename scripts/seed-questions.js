...
var questions_1 = require("../lib/constants/questions");
...
function seedQuestions() {
    return __awaiter(this, void 0, void 0, function () {
        var formattedQuestions, _a, data, error;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    console.log('Starting to seed questions...');
                    formattedQuestions = questions_1.ALL_QUESTIONS.map(function (q) {
                        // The question object structure is different for Step 1 vs Step 3
                        var isStep1 = 'text' in q;
                        return {
                            id: q.id,
                            question_text: isStep1 ? q.text : q.question,
                            options: 'options' in q ? q.options : null,
                            // Add other fields as necessary to match your table schema
                        };
                    });
                    return [4 /*yield*/, supabase.from('questions').upsert(formattedQuestions, {
                            onConflict: 'id',
                        })];
                case 1:
                    ...
                    if (Array.isArray(data)) {
                        console.log("Upserted ".concat(data.length, " questions."));
                    }
                    return [2 /*return*/];
            }
        });
